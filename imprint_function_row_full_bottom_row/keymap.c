...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT_fun_full_bottom_row(
        ...
        _______,  _______,  KC_GRAVE, KC_LEFT, KC_RIGHT,    KC_LCTL, KC_LGUI, _______,             _______, KC_BSPC,  KC_SPC,  _______, KC_UP, KC_DOWN, KC_LBRC, KC_RBRC,    _______,
                                                        KC_LALT, TOGGLE_RAISE, KC_HOME,          KC_F12,  TOGGLE_RAISE,  MOD_SUPER
    ),
    ...
    [_RAISE] = LAYOUT_fun_full_bottom_row(
        ...
        _______, _______, _______, _______, _______, _______,                           _______, _______, TOGGLE_RAISE,   KC_END,  _______, _______,
