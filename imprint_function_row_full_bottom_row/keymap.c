...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT_fun_full_bottom_row(
        ...
        //                                                     1       2        3                     7            8        9
        _______,  _______,  KC_GRAVE, KC_LEFT, KC_RIGHT,    KC_LCTL, KC_LALT, TOGGLE_RAISE,        TOGGLE_RAISE, MOD_SUPER, KC_SPC,     KC_UP, KC_DOWN, KC_LBRC, KC_RBRC,    _______,
        //                                                  4        5        6                   10       11      12
                                                        KC_LGUI, _______, KC_HOME,           KC_END,  KC_F12,  KC_BSPC
    ),
